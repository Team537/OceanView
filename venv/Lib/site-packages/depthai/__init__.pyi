...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CFE0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CFC0>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CFA0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CF80>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CF60>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x0416CF40>, keepAspectRatio: bool = True) -> list[list[float]]
...
class Device(DeviceBase):
    ...
    def getQueueEvents(self, queueNames: list[str], maxNumEvents: int = ..., timeout: datetime.timedelta = ...) -> list[str]:
        ...
        1. getQueueEvents(self: depthai.Device, queueNames: list[str], maxNumEvents: int = 4294967295, timeout: datetime.timedelta = datetime.timedelta(days=-1, seconds=86399, microseconds=999999)) -> list[str]
        ...
        2. getQueueEvents(self: depthai.Device, queueName: str, maxNumEvents: int = 4294967295, timeout: datetime.timedelta = datetime.timedelta(days=-1, seconds=86399, microseconds=999999)) -> list[str]
        ...
        3. getQueueEvents(self: depthai.Device, maxNumEvents: int = 4294967295, timeout: datetime.timedelta = datetime.timedelta(days=-1, seconds=86399, microseconds=999999)) -> list[str]
